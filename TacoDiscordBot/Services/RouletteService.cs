...
public sealed class RouletteService
{
    ...
    [
        ...
        TimeSpan.FromMilliseconds(250), TimeSpan.FromMilliseconds(300),
        TimeSpan.FromMilliseconds(300), TimeSpan.FromMilliseconds(350),
        TimeSpan.FromMilliseconds(400), TimeSpan.FromMilliseconds(500),
        TimeSpan.FromMilliseconds(700), TimeSpan.FromMilliseconds(1000)
    ];
