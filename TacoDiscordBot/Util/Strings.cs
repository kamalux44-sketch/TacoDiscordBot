    ...
    public static readonly string[] birthdayMessages = new[]
{
        ...
        "本日の主役がログインしました！",
        "ステータス[年齢]が上昇しました！",
        "誕生日ボーナスとして、特別な特典が...あるかもしれません！",
        "本日の主役です！たくさん祝われてください！",
        "今年も無事に誕生日を迎えられました。えらい！",
        "次の誕生日まで、あと一年です！",
        "前回の誕生日から「人生」を8,760時間プレイしました！",
        "本日のミッション：「誕生日を楽しむ」達成してください！",
        "サーバーから祝福の気持ちをお届けします！🎁",
        "bot製作者からお祝いのメッセージが届いています > 「たんおめ～～～～！今年もよろしく～～～！」",
        "bot製作者からお祝いのメッセージが届いています > 「おめでとう！長生きしろよ～～～！」",
        "bot製作者からお祝いのメッセージが届いています > 「今年も元気にインターネットしような！」",
        "bot製作者からお祝いのメッセージが届いています > 「おめでと！プレゼントはPayPayで！」",
    };
