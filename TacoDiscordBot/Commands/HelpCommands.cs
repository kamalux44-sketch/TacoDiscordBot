        ...
        new Dictionary<string, (string Label, ButtonStyle Style, string Guide)>
        {
            ...
            ["casino"] = ("🎰 カジノ", ButtonStyle.Danger,
                ...
                + "ベット額は1以上かつ所持コイン以内です。\n\n"
                 ...
                 + "```\n"
                 + "卓を作成すると4文字の卓番号と「参加」ボタンが表示されます。2人目が参加するとゲームが自動開始し、最大6人まで参加できます。\n\n"
                 + "【CoinとChip】\n"
                 ...
                 + "【手札の表示】\n"
                 + "手札は参加者本人だけに表示されます。他のプレイヤーの手札や交換内容は公開されません。手札メッセージを削除した場合は、公開卓の「🔄 手札を再表示」ボタンを押してください。\n\n"
                 + "Pokerのゲーム状態は保存されるため、Bot再起動後も卓、手札、Chip、Pot、Bet状況を復元できます。公開卓メッセージが削除されていた場合は再作成されます。\n"
                 + "・参加費以上のCoinが必要です。\n"
                 + "・ゲーム開始後は参加できません。\n"
