        ...
        new Dictionary<string, (string Label, ButtonStyle Style, string Guide)>
        {
            ...
            ["casino"] = ("🎰 カジノ", ButtonStyle.Danger,
                ...
                + "・敗北・BUST：0\n\n"
                 ...
                 + "【開始条件】\n"
                 + "・`bet`は正の整数です。\n"
                 + "・2人目の参加時に、両者から基本ベット額を徴収します。\n"
                 + "・開始時に、両者が基本ベット額を所持している必要があります。\n"
                 + "・fieldはベット額×2です。\n\n"
                 + "【倍率】\n"
                 + "終了時の実際の石数比から倍率を計算します。盤面に空きマスが残る40:23のような結果にも対応します。\n"
                 + "基準値：33:31=1.0倍、36:28=1.2倍、40:24=1.8倍、44:20=2.4倍、48:16=3.4倍\n"
                 + "52:12=4.7倍、56:8=6.2倍、58:6=7.0倍、60:4=8.0倍、62:2=8.0倍\n"
                 + "基準値の間は補間します。通常倍率の上限は8.0倍です。\n"
                 + "64:0の完勝だけは特別に10.0倍です。\n\n"
                 + "【精算】\n"
                 + "・勝者への払い戻しはfield×倍率です。\n"
                 + "・不足分は敗者の残高を0まで追加徴収します。\n"
                 + "・敗者の残高が不足していても、勝者には全額を支払います。\n"
                 + "・引き分けは両者へ基本ベット額を返金します。\n\n"
                + "`/doubleup bet:<額>`\n"
