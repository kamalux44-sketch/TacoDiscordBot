...
{
    public BlackjackGame(ulong guildId, ulong userId, long bet, IReadOnlyList<BlackjackCard> playerCards, IReadOnlyList<BlackjackCard> dealerCards, IEnumerable<BlackjackCard> deck)
    {
        GuildId = guildId;
        UserId = userId;
        Bet = bet;
